...
| `POST /admin/reload-profiles` (HTTP route, deliberately NOT a tool) | Pick up a new profile without a restart |
...
| `parsed_without_profile` | Full content returned; add a profile for typed rows |
